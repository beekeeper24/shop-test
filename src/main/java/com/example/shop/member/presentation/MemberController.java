...
public class MemberController {
    ...
    @PostMapping
    public ResponseEntity<MemberInfo> create(@RequestBody MemberCommand toCommand) {
        return memberService.create(toCommand);
    }
    ...
    @PutMapping("{id}")
    public ResponseEntity<MemberInfo> update(@RequestBody MemberCommand toCommand, @PathVariable String id) {
        return memberService.update(id, toCommand);
    }
